...
#define KEYWORDS_RE       ";|:>|ADD|SUB|MUL|,|=|<>|\\[|\\]|\\(|\\)|\\{|\\}|PROGRAM|DATA|START|FINISH|WRITE|READ|IF|ELSE|FOR|TO|DO|DIV|MOD|LE|GE|!|AND|\\||INT32_t"

#define IDENTIFIERS_RE    "_[a-z][0-9][0-9]"
...
{ LA_IS, { T_NAME_0 }, { "program_rule",{\
    { LA_IS, {""}, 9, { T_NAME_0, "program_name", T_SEMICOLON_0, T_DATA_0, "declaration__optional", T_SEMICOLON_0,  T_BEGIN_0, "statement__iteration", T_END_0 }}\
}}},\
